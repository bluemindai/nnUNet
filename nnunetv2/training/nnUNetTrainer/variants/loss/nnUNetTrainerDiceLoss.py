...
class nnUNetTrainerDiceCELoss_noSmooth_50epochs(nnUNetTrainer_50epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_75epochs(nnUNetTrainer_75epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_100epochs(nnUNetTrainer_100epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_150epochs(nnUNetTrainer_150epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_250epochs(nnUNetTrainer_250epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_500epochs(nnUNetTrainer_500epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_1000epochs(nnUNetTrainer_1000epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_2000epochs(nnUNetTrainer_2000epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
...
class nnUNetTrainerDiceCELoss_noSmooth_4000epochs(nnUNetTrainer_4000epochs):
    def _build_loss(self):
        # set smooth to 0
        if self.label_manager.has_regions:
            loss = DC_and_BCE_loss({},
